            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="custom-control custom-radio">
                            <input value="barang_kardus" type="radio" id="barang_west" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="barang_west">Barang West</label>
                        </div>
