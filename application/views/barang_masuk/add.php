        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group" id="ttstok">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input id="panjang" type="number" class="form-control" step="0.1" placeholder="P" required="">
                            <input id="lebar" type="number" class="form-control" step="0.1" placeholder="L" required="">
                            <input id="berat" type="number" class="form-control" step="0.1" placeholder="0 Kg" required="">                            
                        </div>
                        <input type="text" name="ukuran" id="ukuran" class="form-control d-none">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_stok">Jumlah dalam PCS</label>
                    <div class="col-md-5">
                        <input id="qty_pcs" name="qty_pcs" type="number" class="form-control" placeholder="Jumlah (PCS)" required="">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input name="harga_masuk" id="harga_masuk" type="number" class="form-control" placeholder="Harga..">
